"""
LUMIMAP Phase 2 - Week1-3 with Relaxed Thresholds
==================================================

Uses Week1, Week2, Week3 for more data variety
Should generate diverse resistance labels
"""
...
# ============================================================================
# CONFIGURATION - 3 WEEKS + RELAXED THRESHOLDS
# ============================================================================
...
class Config:
    ...
    # USE 3 WEEKS instead of 1
    WEEKS_TO_USE = ['Week1', 'Week2', 'Week3']

print("🚀 PHASE 2 - Week1-3 + RELAXED THRESHOLDS")
print(f"   Using: {Config.WEEKS_TO_USE}")
print(f"   Thresholds: DMSO={Config.DMSO_HIGH_SIMILARITY}, MOA={Config.MOA_HIGH_SIMILARITY}")
...
def main():
    print("\n" + "="*70)
    print("LUMIMAP PHASE 2 - Week1-3 + RELAXED")
    print("="*70)
    ...
    if n_types >= 3:
        ...
        print(f"⚠️  WARNING: Only {n_types} types found")
        print("   Consider retraining Phase 1 with all 6 weeks")
